...
description: >-
  ...
  [Goose](https://block.github.io/goose/), and
  [Aider](https://github.com/paul-gauthier/aider) are becoming increasingly
  popular for:
version: main
audience: all
---
...
- A [Coder deployment](../install/index) with v2.21.0 or later
- A Coder [template](../admin/templates/index) for your project(s).
