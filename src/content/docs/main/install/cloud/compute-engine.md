...
description: >-
  In this guide, you will learn how to deploy the Coder control plane instance
  and
version: main
audience: infra
---
...
![Coder on GCP Marketplace](%images/%images/./../images/platforms/gcp/marketplace.png)
...
![Coder on GCP Marketplace start](%images/%images/./../images/platforms/gcp/start.png)
...
![Coder Workspace and IDE in GCP VM](%images/%images/./../images/platforms/aws/workspace.png)
...
- [Use your IDE with Coder](../../user-guides/workspace-access/index)
