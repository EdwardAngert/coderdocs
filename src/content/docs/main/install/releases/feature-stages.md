...
description: Some Coder features are released in feature stages before they are generally
version: main
audience: infra
---
# Feature stages
...
Use the [Coder CLI](../../install/cli) `--experiments` flag to enable early access features:
...
You can also use the `CODER_EXPERIMENTS` [environment variable](../../admin/setup/index).
...
We intend [Coder documentation](../../README) to be the [single source of truth](https://en.wikipedia.org/wiki/Single_source_of_truth) and all features should have some form of complete documentation that outlines how to use or implement a feature.
